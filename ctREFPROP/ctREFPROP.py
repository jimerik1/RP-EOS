...
class REFPROPInstance(object):
    ...
    def __init__(self, dll, managed_handle = None):
        ...
        # Now, update the function lookups.
        # Note: The attribute names remain unchanged; only the lookup string (second parameter)
        # is now in lowercase to match your Fortran compiled library.
        ...
        self._VIRBAdll = self._getfcn(self.dll, 'virbaddll')
