...
def run_composition_tests():
    ...
    compositions = [
        ...
        {
            "description": "90% CO2, 10% Hydrogen (testing hydrogen impact)",
            "components": [
                {"fluid": "CO2", "fraction": 0.90},
        ...
        {
            "description": "80% CO2, 10% Methane, 10% Hydrogen (testing hydrogen with 3 components)",
            "components": [
                {"fluid": "CO2", "fraction": 0.80},
                {"fluid": "METHANE", "fraction": 0.10},
                {"fluid": "HYDROGEN", "fraction": 0.10}
        ...
        {
            "description": "70% CO2, 10% Methane, 10% Ethane, 10% Hydrogen (testing hydrogen with 4 components)",
            "components": [
                {"fluid": "CO2", "fraction": 0.70},
                {"fluid": "METHANE", "fraction": 0.10},
                {"fluid": "ETHANE", "fraction": 0.10},
        ...
        {
            "description": "60% CO2, 10% Methane, 10% Ethane, 10% Propane, 10% Hydrogen (testing hydrogen with 5 components)",
            "components": [
                {"fluid": "CO2", "fraction": 0.60},
                {"fluid": "METHANE", "fraction": 0.10},
                {"fluid": "ETHANE", "fraction": 0.10},
